          ...
          <div class="product-thumb">
            ...
            <div>
              ...
              <div class="button-group">
                <button style="display:none;" style="display:none;" type="button" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');"><i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md"><?php echo $button_cart; ?></span></button>
                <button type="button" data-toggle="tooltip" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-heart"></i></button>
                <button type="button" style="cursor:auto;"> <i class="fa fa-eye"></i><span style="display: inline-block;margin-left:10px;"><?php echo $product['viewed']; ?></span></button>
                <button style="display:none;" style="display:none;" type="button" data-toggle="tooltip" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-exchange"></i></button>
              </div>
            </div>
          </div>
        </div>
