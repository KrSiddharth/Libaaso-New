...
class ControllerInformationStatic extends Controller {
    ...
    public function index() {
        $this->load->language('information/static'); //Optional. This calls for your language file
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/information/static.tpl')) { //if file exists in your current template folder
            ...
            $this->response->setOutput($this->load->view($this->template = 'default/template/information/static.tpl',$data)); //or get the file from the default folder
        }
