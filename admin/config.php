<?php
// HTTP
define('HTTP_SERVER', 'http://www.libaaso.com/admin/');
define('HTTP_CATALOG', 'http://www.libaaso.com/');

// HTTPS
define('HTTPS_SERVER', 'http://www.libaaso.com/admin/');
define('HTTPS_CATALOG', 'http://www.libaaso.com/');
